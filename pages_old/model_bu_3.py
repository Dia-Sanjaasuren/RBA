...
column_defs = [
    ...
    {"field": "TTV", "headerName": "TTV", "aggFunc": "sum", "cellStyle": {"backgroundColor": "#fff", "text-align": "right"}, "valueFormatter": "x == null ? '' : x.toLocaleString(undefined, {maximumFractionDigits:0})", "resizable": True, "width": 140},
    {"field": "% of TTV", "headerName": "% of TTV", "cellStyle": {"backgroundColor": "#fff", "text-align": "right"}, "valueFormatter": "x == null ? '' : Number(x).toFixed(2) + '%'", "resizable": True, "width": 140},
    {"field": "TTV (Assump)", "headerName": "TTV", "aggFunc": "sum", "cellStyle": {"backgroundColor": "#e3f2fd", "text-align": "right"}, "valueFormatter": "x == null ? '' : x.toLocaleString(undefined, {maximumFractionDigits:0})", "resizable": True, "width": 140},
    ...
    {"field": "MSF ex gst", "headerName": "MSF", "aggFunc": "sum", "cellStyle": {"backgroundColor": "#fff", "text-align": "right"}, "valueFormatter": "x == null ? '' : x.toLocaleString(undefined, {maximumFractionDigits:0})", "resizable": True, "width": 140},
    {"field": "% of MSF", "headerName": "% of MSF", "cellStyle": {"backgroundColor": "#fff", "text-align": "right"}, "valueFormatter": "x == null ? '' : Number(x).toFixed(2) + '%'", "resizable": True, "width": 140},
    {"field": "MSF ex gst (Assump)", "headerName": "MSF", "aggFunc": "sum", "cellStyle": {"backgroundColor": "#e3f2fd", "text-align": "right"}, "valueFormatter": "x == null ? '' : x.toLocaleString(undefined, {maximumFractionDigits:0})", "resizable": True, "width": 140},
    ...
    {"field": "COA ex gst", "headerName": "COA", "aggFunc": "sum", "cellStyle": {"backgroundColor": "#fff", "text-align": "right"}, "valueFormatter": "x == null ? '' : x.toLocaleString(undefined, {maximumFractionDigits:0})", "resizable": True, "width": 140},
    {"field": "% of COA", "headerName": "% of COA", "cellStyle": {"backgroundColor": "#fff", "text-align": "right"}, "valueFormatter": "x == null ? '' : Number(x).toFixed(2) + '%'", "resizable": True, "width": 140},
    {"field": "COA ex gst (Assump)", "headerName": "COA", "aggFunc": "sum", "cellStyle": {"backgroundColor": "#e3f2fd", "text-align": "right"}, "valueFormatter": "x == null ? '' : x.toLocaleString(undefined, {maximumFractionDigits:0})", "resizable": True, "width": 140},
    ...
    {"field": "GP ex gst", "headerName": "GP", "aggFunc": "sum", "cellStyle": {"backgroundColor": "#fff", "text-align": "right"}, "valueFormatter": "x == null ? '' : x.toLocaleString(undefined, {maximumFractionDigits:0})", "resizable": True, "width": 140},
    {"field": "% of GP", "headerName": "% of GP", "cellStyle": {"backgroundColor": "#fff", "text-align": "right"}, "valueFormatter": "x == null ? '' : Number(x).toFixed(2) + '%'", "resizable": True, "width": 140},
    {"field": "GP ex gst (Assump)", "headerName": "GP", "aggFunc": "sum", "cellStyle": {"backgroundColor": "#e3f2fd", "text-align": "right"}, "valueFormatter": "x == null ? '' : x.toLocaleString(undefined, {maximumFractionDigits:0})", "resizable": True, "width": 140},
...
# Wrap AgGrid in a horizontally scrollable div
...
# Update assumption value columns based on edited assumption percent columns
metrics = [
    ('TTV', '% of TTV', 'TTV (Assump)', '% of TTV (Assump)'),
    ('MSF ex gst', '% of MSF', 'MSF ex gst (Assump)', '% of MSF (Assump)'),
    ('COA ex gst', '% of COA', 'COA ex gst (Assump)', '% of COA (Assump)'),
...
business_units = edited_df['Business Unit'].dropna().unique()
for bu in business_units:
    card_mask = (edited_df['Business Unit'] == bu) & (edited_df['Card Type'] != '')
    for metric, pct, metric_assump, pct_assump in metrics:
        total = edited_df.loc[card_mask, metric].sum()
        edited_df.loc[card_mask, metric_assump] = (
            total * edited_df.loc[card_mask, pct_assump] / 100
        )
